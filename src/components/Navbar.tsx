...
const Navbar = ({ action }: NavbarProps) => {
  return (
    <header>
      <nav className="bg-purple h-20 border-b border-white/10">
          ...
          <div className="flex items-center w-[125px] justify-start">
            <div className="flex items-center gap-1.5">
              <div className="w-[26px] h-[26px]">
                <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#034697] shadow-[0_6px_18px_rgba(3,70,151,0.3)]">
                  <span className="font-outfit text-[13px] font-black tracking-[-0.08em] text-white">i8</span>
                </div>
                <svg className="hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                  <path
              ...
              <span className="text-[29px] font-outfit font-bold tracking-[-0.04em]">Innov8<span className="text-[#e2a025]">IT</span></span>
            </div>
          </div>
          <div className="hidden sm:flex items-center text-sm flex-1">
            <ul className="flex flex-1 leading-[1.555] -tracking-[.0012em]">
              <NavLink dropdown>Platform</NavLink>
